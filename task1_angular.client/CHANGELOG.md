...
- Create Angular project with ng: `ng new task1_angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task1_angular.client.esproj`).
